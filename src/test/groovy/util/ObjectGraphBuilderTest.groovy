...
class Employee {
    ...
    String toString() {
        "Employee=[name:${name}, employeeId:${employeeId}, address:${address}, company:${company.name}]"
    }
}
...
class ReflectionCompany {
    ...
    String toString() {
        "Company=[name:${name}, address:${address}, director:${md}, financialController:${cio}, drones:${drones}]"
    }
}
